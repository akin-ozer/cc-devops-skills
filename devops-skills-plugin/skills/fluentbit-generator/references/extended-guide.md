# Fluent Bit Config Generator: Extended Guide
...
cd devops-skills-plugin/skills/fluentbit-generator
python3 scripts/generate_config.py --help
```

```bash
# Option B: resolve the skill from the current repository
SKILL_DIR="$(git rev-parse --show-toplevel)/devops-skills-plugin/skills/fluentbit-generator"
python3 "$SKILL_DIR/scripts/generate_config.py" --help
```
