# Terragrunt Generator: Extended Guide
> Use this guide selectively. `SKILL.md` defines the current workflow; the examples and detailed checklists below apply only when the task needs them and do not override repository context or safety constraints.
...
- [Feature Flags](https://terragrunt.gruntwork.io/docs/reference/hcl/blocks/#feature) - Runtime control via `feature` blocks
...
**Docs:** [Feature Flags Documentation](https://terragrunt.gruntwork.io/docs/reference/hcl/blocks/#feature)
...
| `run-all` | `run --all` | [Migration](https://terragrunt.gruntwork.io/docs/migrate/cli-redesign/#use-run---all-instead-of-run-all) |
...
- [Feature Flags](https://terragrunt.gruntwork.io/docs/reference/hcl/blocks/#feature)
